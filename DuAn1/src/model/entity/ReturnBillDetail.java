...
public class ReturnBillDetail {
    ...
    public ReturnBillDetail(double priceAtTheTimeOfPurchase, int quantityOfProductsReturned, Date createdAt, String id, ProductDetail productDetailId, ReturnBill returnBillId, Date updatedAt, String status) {
    ...
    public double getPriceAtTheTimeOfPurchase() {
        return priceAtTheTimeOfPurchase;
    }

    public void setPriceAtTheTimeOfPurchase(double priceAtTheTimeOfPurchase) {
        this.priceAtTheTimeOfPurchase = priceAtTheTimeOfPurchase;
    }
