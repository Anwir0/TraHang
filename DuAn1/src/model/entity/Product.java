...
public class Product {
    ...
    public Product(double product_price, Date created_at, String id, SaleProduct sale_id, Date updated_at, String name_product, String status) {
    ...
    public Product(double product_price, Date created_at, Custom custome_id, String id, Material material_id, SaleProduct sale_id, Thickness thickness_id, Date updated_at, String description, String name_product, String status) {
        this.product_price = product_price;
        this.created_at = created_at;
